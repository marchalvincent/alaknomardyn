...
public class TransMetaObj extends Metaobject 
{
    ...
    /**
     * Permet d'intercepter les appels des méthodes débutant par "set".
     * Avant la réalisation de la méthode nous réalisons une sauvegarde
     * les objets passé en parametre via les {@link BackupManager}
     * dans la pile présente dans la class {@link MethodeCouranteManager}.
     * Dans le cas d'une exception nous restaurons les variables sauvegardées.
     */
