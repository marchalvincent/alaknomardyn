...
/**
 * Un compte bancaire qui est {@link Transactionnable} et dont les transferts d'argent se doivent d'être cohérents.
 * 
...
public class CompteBancaire {
     ...
     *             Une exception est levée pendant le transfert d'argent
     */
	...
	try {
	    ...
	    /*
	     * comme la méthode n'est pas transactionnable, le débit est faussé, imaginons aucun traitement. Du coup, le compte
	     * "this" n'a plus du tout le bon montant...
	     */
	}
	...
	try {
	    ...
	    // comme la méthode est transactionnable, le débit est automatiquement annulé, on imagine qu'il n'y a pas de
	    // traitement manuel
	}
